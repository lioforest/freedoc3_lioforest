...
ActiveRecord::Schema.define(version: 2019_04_25_142904) do
  ...
  create_table "join_table_specialty_doctor", force: :cascade do |t|
    t.integer "doctor_id"
    t.integer "specialty_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_join_table_specialty_doctor_on_doctor_id"
    t.index ["specialty_id"], name: "index_join_table_specialty_doctor_on_specialty_id"
  end
